---
title: 第12讲：有哪 6 种常见的线程池？什么是 Java8 的 ForkJoinPool？
date: 2021-02-25 21:30:00
tags:
 - java
 - thread
categories:
 - concurrent
sidebar: true
pre: ./juc-11-thread-pool-rejection
next: ./juc-13-thread-pool-and-queue
---
...
![fixed-thread-pool.jpeg](./../../../images/fixed-thread-pool.jpeg)
...
![thread-pool-args-table.jpeg](./../../../images/thread-pool-args-table.jpeg)
...
![fibonacci.jpeg](./../../../images/fibonacci.jpeg)

在计算 f(4) 时需要首先计算出 f(2) 和 f(3)，而同理，计算 f(3) 时又需要计算 f(1) 和 f(2)，以此类推。
![fibonacci-task.jpeg](./../../../images/fibonacci-task.jpeg)
...
class Fibonacci extends RecursiveTask<Integer> { 
 ...
 ```
我们看到它首先继承了 R就是 f1 和 f2，然后我们用 fork() 方法分裂任务并分别执行，最后在 return 的时候，使用 join() 方法把结果汇总，这样就实现了任务的分裂和汇总。
...
![forkjoin-queue.jpeg](./../../../images/forkjoin-queue.jpeg)
...
![forkjoin-work-stealing.jpeg](./../../../images/forkjoin-work-stealing.jpeg)
...
![forkjoin-working-flow.jpeg](./../../../images/forkjoin-working-flow.jpeg)
