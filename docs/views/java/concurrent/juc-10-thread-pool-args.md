---
title: 第10讲：线程池的各个参数的含义？
date: 2021-02-25 20:30:00
tags:
 - java
 - thread
categories:
 - concurrent
sidebar: true
pre: ./juc-09-why-we-use-thread-pool
next: ./juc-11-thread-pool-rejection
---
...
## 线程池的参数
![thread-pool-args.jpeg](./../../../images/thread-pool-args.jpeg)
...
## 线程创建的时机
![thread-pool-add-task-flow.jpeg](./../../../images/thread-pool-add-task-flow.jpeg)
...
![thread-pool-pool-size-sample.jpeg](./../../../images/thread-pool-pool-size-sample.jpeg)
