...
categories:
 - concurrent
sidebar: true
pre: ./juc-12-thread-pool-samples
...
## 线程池内部结构
![thread-pool-inner-structure.jpeg](./../../../images/thread-pool-inner-structure.jpeg)            
...
## 阻塞队列
![thread-pool-vs-queue.jpeg](./../../../images/thread-pool-vs-queue.jpeg) 
